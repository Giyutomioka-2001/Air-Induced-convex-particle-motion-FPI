...
%% Figure 1: Padé vs. Exact for sin(pi*x)
figure;
sgtitle('Padé Scheme vs. Exact for sin(\pi x)');
...
%% Figure 2: Central Difference vs. Exact for sin(pi*x)
figure;
sgtitle('Central Difference vs. Exact for sin(\pi x)');
