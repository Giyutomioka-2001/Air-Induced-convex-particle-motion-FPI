...
for step = 1:numSteps
    ...
    for i = 1:N_particles
        ...
        % Compute lift force strictly using the given formula
       % Compute lift force direction dynamically (perpendicular to velocity)
% Compute lift force strictly using the given formula
% Compute lift force direction dynamically (perpendicular to velocity)
...
particles(i).lift_force = lift_direction * lift_magnitude; % Apply lift in both x and y directions
